...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetConversion: {
       ...
       **/
      LiquidityAdded: AugmentedEvent<ApiType, [who: AccountId32, mintTo: AccountId32, poolId: ITuple<[StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>, amount1Provided: u128, amount2Provided: u128, lpToken: u32, lpTokenMinted: u128], { who: AccountId32, mintTo: AccountId32, poolId: ITuple<[StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>, amount1Provided: u128, amount2Provided: u128, lpToken: u32, lpTokenMinted: u128 }>;
      /**
       * A successful call of the `RemoveLiquidity` extrinsic will create this event.
       **/
      LiquidityRemoved: AugmentedEvent<ApiType, [who: AccountId32, withdrawTo: AccountId32, poolId: ITuple<[StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>, amount1: u128, amount2: u128, lpToken: u32, lpTokenBurned: u128, withdrawalFee: Permill], { who: AccountId32, withdrawTo: AccountId32, poolId: ITuple<[StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>, amount1: u128, amount2: u128, lpToken: u32, lpTokenBurned: u128, withdrawalFee: Permill }>;
      /**
       * A successful call of the `CreatePool` extrinsic will create this event.
       **/
      PoolCreated: AugmentedEvent<ApiType, [creator: AccountId32, poolId: ITuple<[StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>, poolAccount: AccountId32, lpToken: u32], { creator: AccountId32, poolId: ITuple<[StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>, poolAccount: AccountId32, lpToken: u32 }>;
      /**
       * Assets have been converted from one to another.
       **/
      SwapCreditExecuted: AugmentedEvent<ApiType, [amountIn: u128, amountOut: u128, path: Vec<ITuple<[StagingXcmV3MultiLocation, u128]>>], { amountIn: u128, amountOut: u128, path: Vec<ITuple<[StagingXcmV3MultiLocation, u128]>> }>;
      /**
       * Assets have been converted from one to another. Both `SwapExactTokenForToken`
       * and `SwapTokenForExactToken` will generate this event.
       **/
      SwapExecuted: AugmentedEvent<ApiType, [who: AccountId32, sendTo: AccountId32, amountIn: u128, amountOut: u128, path: Vec<ITuple<[StagingXcmV3MultiLocation, u128]>>], { who: AccountId32, sendTo: AccountId32, amountIn: u128, amountOut: u128, path: Vec<ITuple<[StagingXcmV3MultiLocation, u128]>> }>;
      /**
       * Pool has been touched in order to fulfill operational requirements.
       **/
      Touched: AugmentedEvent<ApiType, [poolId: ITuple<[StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>, who: AccountId32], { poolId: ITuple<[StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>, who: AccountId32 }>;
      /**
       * Generic event
       **/
    ...
    assetConversionMigration: {
       ...
       **/
      MigratedToNewAccount: AugmentedEvent<ApiType, [poolId: ITuple<[StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>, priorAccount: AccountId32, newAccount: AccountId32], { poolId: ITuple<[StagingXcmV3MultiLocation, StagingXcmV3MultiLocation]>, priorAccount: AccountId32, newAccount: AccountId32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    assetTxPayment: {
       ...
       **/
      AssetTxFeePaid: AugmentedEvent<ApiType, [who: AccountId32, actualFee: u128, tip: u128, assetId: StagingXcmV3MultiLocation], { who: AccountId32, actualFee: u128, tip: u128, assetId: StagingXcmV3MultiLocation }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    foreignAssets: {
       ...
       * Accounts were destroyed for given asset.
       **/
      AccountsDestroyed: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, accountsDestroyed: u32, accountsRemaining: u32], { assetId: StagingXcmV3MultiLocation, accountsDestroyed: u32, accountsRemaining: u32 }>;
      /**
       * An approval for account `delegate` was cancelled by `owner`.
       **/
      ApprovalCancelled: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, owner: AccountId32, delegate: AccountId32], { assetId: StagingXcmV3MultiLocation, owner: AccountId32, delegate: AccountId32 }>;
      /**
       * Approvals were destroyed for given asset.
       **/
      ApprovalsDestroyed: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, approvalsDestroyed: u32, approvalsRemaining: u32], { assetId: StagingXcmV3MultiLocation, approvalsDestroyed: u32, approvalsRemaining: u32 }>;
      /**
       * (Additional) funds have been approved for transfer to a destination account.
       **/
      ApprovedTransfer: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, source: AccountId32, delegate: AccountId32, amount: u128], { assetId: StagingXcmV3MultiLocation, source: AccountId32, delegate: AccountId32, amount: u128 }>;
      /**
       * Some asset `asset_id` was frozen.
       **/
      AssetFrozen: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation], { assetId: StagingXcmV3MultiLocation }>;
      /**
       * The min_balance of an asset has been updated by the asset owner.
       **/
      AssetMinBalanceChanged: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, newMinBalance: u128], { assetId: StagingXcmV3MultiLocation, newMinBalance: u128 }>;
      /**
       * An asset has had its attributes changed by the `Force` origin.
       **/
      AssetStatusChanged: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation], { assetId: StagingXcmV3MultiLocation }>;
      /**
       * Some asset `asset_id` was thawed.
       **/
      AssetThawed: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation], { assetId: StagingXcmV3MultiLocation }>;
      /**
       * Some account `who` was blocked.
       **/
      Blocked: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, who: AccountId32], { assetId: StagingXcmV3MultiLocation, who: AccountId32 }>;
      /**
       * Some assets were destroyed.
       **/
      Burned: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, owner: AccountId32, balance: u128], { assetId: StagingXcmV3MultiLocation, owner: AccountId32, balance: u128 }>;
      /**
       * Some asset class was created.
       **/
      Created: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, creator: AccountId32, owner: AccountId32], { assetId: StagingXcmV3MultiLocation, creator: AccountId32, owner: AccountId32 }>;
      /**
       * Some assets were deposited (e.g. for transaction fees).
       **/
      Deposited: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, who: AccountId32, amount: u128], { assetId: StagingXcmV3MultiLocation, who: AccountId32, amount: u128 }>;
      /**
       * An asset class was destroyed.
       **/
      Destroyed: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation], { assetId: StagingXcmV3MultiLocation }>;
      /**
       * An asset class is in the process of being destroyed.
       **/
      DestructionStarted: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation], { assetId: StagingXcmV3MultiLocation }>;
      /**
       * Some asset class was force-created.
       **/
      ForceCreated: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, owner: AccountId32], { assetId: StagingXcmV3MultiLocation, owner: AccountId32 }>;
      /**
       * Some account `who` was frozen.
       **/
      Frozen: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, who: AccountId32], { assetId: StagingXcmV3MultiLocation, who: AccountId32 }>;
      /**
       * Some assets were issued.
       **/
      Issued: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, owner: AccountId32, amount: u128], { assetId: StagingXcmV3MultiLocation, owner: AccountId32, amount: u128 }>;
      /**
       * Metadata has been cleared for an asset.
       **/
      MetadataCleared: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation], { assetId: StagingXcmV3MultiLocation }>;
      /**
       * New metadata has been set for an asset.
       **/
      MetadataSet: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, name: Bytes, symbol_: Bytes, decimals: u8, isFrozen: bool], { assetId: StagingXcmV3MultiLocation, name: Bytes, symbol: Bytes, decimals: u8, isFrozen: bool }>;
      /**
       * The owner changed.
       **/
      OwnerChanged: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, owner: AccountId32], { assetId: StagingXcmV3MultiLocation, owner: AccountId32 }>;
      /**
       * The management team changed.
       **/
      TeamChanged: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, issuer: AccountId32, admin: AccountId32, freezer: AccountId32], { assetId: StagingXcmV3MultiLocation, issuer: AccountId32, admin: AccountId32, freezer: AccountId32 }>;
      /**
       * Some account `who` was thawed.
       **/
      Thawed: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, who: AccountId32], { assetId: StagingXcmV3MultiLocation, who: AccountId32 }>;
      /**
       * Some account `who` was created with a deposit from `depositor`.
       **/
      Touched: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, who: AccountId32, depositor: AccountId32], { assetId: StagingXcmV3MultiLocation, who: AccountId32, depositor: AccountId32 }>;
      /**
       * Some assets were transferred.
       **/
      Transferred: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, from: AccountId32, to: AccountId32, amount: u128], { assetId: StagingXcmV3MultiLocation, from: AccountId32, to: AccountId32, amount: u128 }>;
      /**
       * An `amount` was transferred in its entirety from `owner` to `destination` by
       * the approved `delegate`.
       **/
      TransferredApproved: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, owner: AccountId32, delegate: AccountId32, destination: AccountId32, amount: u128], { assetId: StagingXcmV3MultiLocation, owner: AccountId32, delegate: AccountId32, destination: AccountId32, amount: u128 }>;
      /**
       * Some assets were withdrawn from the account (e.g. for transaction fees).
       **/
      Withdrawn: AugmentedEvent<ApiType, [assetId: StagingXcmV3MultiLocation, who: AccountId32, amount: u128], { assetId: StagingXcmV3MultiLocation, who: AccountId32, amount: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    foreignAssetsFreezer: {
      Frozen: AugmentedEvent<ApiType, [who: AccountId32, assetId: StagingXcmV3MultiLocation, amount: u128], { who: AccountId32, assetId: StagingXcmV3MultiLocation, amount: u128 }>;
      Thawed: AugmentedEvent<ApiType, [who: AccountId32, assetId: StagingXcmV3MultiLocation, amount: u128], { who: AccountId32, assetId: StagingXcmV3MultiLocation, amount: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: AssetHubWestendRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: AssetHubWestendRuntimeProxyType, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: AssetHubWestendRuntimeProxyType, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: AssetHubWestendRuntimeProxyType, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: AssetHubWestendRuntimeProxyType, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: AssetHubWestendRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
